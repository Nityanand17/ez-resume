...
export class StorageService implements OnModuleInit {
  ...
  async onModuleInit() {
    try {
      ...
      const skipBucketCheck = this.configService.get<boolean>("STORAGE_SKIP_BUCKET_CHECK") || false;
      ...
      try {
        ...
        // This is useful when using MongoDB Atlas without a properly configured storage service
