...
export class AuthController {
  ...
  @Post("mongodb-atlas/login")
  @UseGuards(MongoDBAtlasGuard)
  async mongoDBAtlasLogin(@User() user: UserWithSecrets, @Res({ passthrough: true }) response: Response) {
    return this.handleAuthenticationResponse(user, response);
  }

  @Post("mongodb-atlas/register")
  @UseGuards(MongoDBAtlasGuard)
  async mongoDBAtlasRegister(@Body() body: any, @User() user: UserWithSecrets, @Res({ passthrough: true }) response: Response) {
    return this.handleAuthenticationResponse(user, response);
  }
