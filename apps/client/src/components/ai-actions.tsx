...
import { changeTone } from "../services/gemini/change-tone";
import { fixGrammar } from "../services/gemini/fix-grammar";
import { improveWriting } from "../services/gemini/improve-writing";
...
export const AiActions = ({ value, onChange, className }: Props) => {
  ...
  const aiEnabled = useLLMStore((state) => !!state.apiKey);
